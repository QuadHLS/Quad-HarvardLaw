...
export function SearchSidebar({
  ...
  return (
    <div className="w-80 bg-[#8B4A6B] text-white flex flex-col">
      {/* Tab Navigation */}
      <div className="flex bg-white px-2 pt-2 pb-0 gap-1">
        <button
        ...
        <>
          ...
          <div className="flex-1 bg-white text-black overflow-y-auto">
            ...
            selectedInstructor === "" ? (
              ...
              <div className="flex flex-col items-center justify-center h-full p-6 text-center">
                <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#752432] mb-4"></div>
                <h3 className="text-lg font-medium text-gray-700 mb-2">
                  Loading Outlines...
                </h3>
                <p className="text-gray-500 text-sm">
                  Please wait while we fetch your outlines.
                </p>
              </div>
            ) : error ? (
              <div className="flex flex-col items-center justify-center h-full p-6 text-center">
