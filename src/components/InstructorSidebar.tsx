...
export function InstructorSidebar({ 
  ...
  return (
    <div className="w-64 style={{ backgroundColor: 'var(--background-color, #f9f5f0)' }} border-l border-gray-200">
      {/* Header */}
          ...
          <div
            ...
            className={`p-3 rounded-lg border cursor-pointer transition-colors ${
              selectedInstructor === instructor.name
                ...
                : 'style={{ backgroundColor: 'var(--background-color, #f9f5f0)' }} hover:style={{ backgroundColor: 'var(--background-color, #f9f5f0)' }} border-gray-200'
            }`}
            ...
            {selectedInstructor === instructor.name && (
              <div className="mt-2 space-y-1">
                {instructor.courses.map(course => (
                  <div key={course} className="text-xs style={{ backgroundColor: 'var(--background-color, #f9f5f0)' }}/20 rounded px-2 py-1">
                    {course}
                  </div>
                ))}
              </div>
