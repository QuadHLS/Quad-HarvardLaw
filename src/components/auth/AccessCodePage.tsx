            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                  disabled={loading}
                  className="h-10 style={{ backgroundColor: 'var(--background-color, #f9f5f0)' }}/5 border-white/10 text-white placeholder:text-gray-400 focus:border-red-600 focus:ring-red-600/20 rounded-lg backdrop-blur-sm text-sm"
                />
              </div>
