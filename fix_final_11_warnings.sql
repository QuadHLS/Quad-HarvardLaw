-- FIX FINAL 11 PERFORMANCE WARNINGS
-- This script fixes the remaining 11 performance warnings
...
-- For Courses table (capital C) - ensure we have minimal policies
...
-- For courses table (lowercase c) - ensure we have minimal policies
...
-- Create minimal consolidated policies for Courses table (capital C)
...
-- Create minimal consolidated policies for courses table (lowercase c)
...
-- For invite_list table - ensure minimal policies
...
-- For professor_courses table - ensure minimal policies
...
-- For professors table - ensure minimal policies
