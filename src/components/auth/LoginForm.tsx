        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            <Input
              ...
              required
              disabled={loading}
              className="pr-12 h-10 style={{ backgroundColor: 'var(--background-color, #f9f5f0)' }}/5 border-white/10 text-white placeholder:text-gray-400 focus:border-red-600 focus:ring-red-600/20 rounded-lg backdrop-blur-sm text-sm"
            />
      ...
      <div className="mt-4">
        ...
        <div className="mt-4">
          <Button
            type="button"
            variant="outline"
            className="w-full h-9 style={{ backgroundColor: 'var(--background-color, #f9f5f0)' }}/5 border-white/10 text-white hover:style={{ backgroundColor: 'var(--background-color, #f9f5f0)' }}/10 hover:border-white/20 rounded-lg backdrop-blur-sm transition-all duration-300 text-sm"
            disabled={loading}
